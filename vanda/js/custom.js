...
$.support.transition = (function(){ 
    ...
    var points_chart_1 = [];
    for (var i = 0; i <= 8; i += 1) {
        points_chart_1.push([i, parseInt(Math.random() * 6)]);
    }

    var points_chart_2 = [];
    for (var i = 0; i <= 4; i += 1) {
        points_chart_2.push([i, parseInt(Math.random() * 5550)]);
    }
    ...
    function plotWithOptions() {
        $.plot("#placeholder_chart_1", [ points_chart_1 ], {
            series: {
                stack: stack,
                lines: {
                    show: lines,
            ...
            grid: {
                hoverable: true,
                clickable: true,
                tickColor: "rgba(192, 57, 43,0.4)",
                borderColor: "rgba(231, 76, 60,0.0)",
                borderWidth: 1
            },
            points: {
                show: true,
        ...
        $.plot("#placeholder_chart_2", [ points_chart_2 ], {
            series: {
                stack: stack,
                lines: {
                    show: lines,
