...
function GetFriend() {
	...
	if (user_ids.length == 0) {
		document.getElementById('friends').innerHTML = ''
								+ '<li class="contact-alpha">'
									+ 'Общие друзья <span class="label label-info pull-right">' + user_ids.length + ' Общих друзей</span>'
									+ '<div class="clearfix"></div>'
								+ '</li><div class="errorL">Нет общих друзей!</div>';
...
function WriteUser(user_info) {
	if (user_info.length > 0) {
		document.getElementById('friends').innerHTML = ''
									+ '<li class="contact-alpha">'
										+ 'Общие друзья <span class="label label-info pull-right">' + user_info.length + ' Общих друзей</span>'
										+ '<div class="clearfix"></div>'
									+ '</li>';
