...
$('.name_result_api').html('<strong>' + api_result.response[0].first_name + ' ' + api_result.response[0].last_name + '</strong><small>ID' + api_result.response[0].uid + ' - Это вы, чтобы добавить себя в список нажмите "+"</small>');
